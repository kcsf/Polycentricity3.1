...
declare module '$env/static/private' {
	...
	export const KMP_AFFINITY: string;
	...
	export const PGMODELER_APP_PATH: string;
	export const PGMODELER_CHANDLER_PATH: string;
	export const PGMODELER_CLI_PATH: string;
	export const PGMODELER_LANG_DIR: string;
	export const PGMODELER_PLUGINS_DIR: string;
	export const PGMODELER_SAMPLES_DIR: string;
	export const PGMODELER_SCHEMAS_DIR: string;
	export const PGMODELER_TMPL_CONF_DIR: string;
	export const PHPRC: string;
	...
	export const SISENSE_JAVA_HOME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		Path: string;
		PATHEXT: string;
		PGMODELER_APP_PATH: string;
		PGMODELER_CHANDLER_PATH: string;
		PGMODELER_CLI_PATH: string;
		PGMODELER_LANG_DIR: string;
		PGMODELER_PLUGINS_DIR: string;
		PGMODELER_SAMPLES_DIR: string;
		PGMODELER_SCHEMAS_DIR: string;
		PGMODELER_TMPL_CONF_DIR: string;
		PHPRC: string;
		PNPM_HOME: string;
