    ...
    <div class="grid grid-cols-1 divide-y border-t sm:grid-cols-4 sm:divide-x sm:divide-y-0">
      <div class="px-6 py-5 text-center">
        <div class="flex flex-col items-center">
          ...
          <span class="text-xl font-medium">{$gamesJoined}</span>
      ...
      <div class="px-6 py-5 text-center">
        <div class="flex flex-col items-center">
          ...
          <span class="text-xl font-medium">{$gamesCreated}</span>
      ...
      <div class="px-6 py-5 text-center">
        <div class="flex flex-col items-center">
          ...
          <span class="text-xl font-medium">{actors.length}</span>
      ...
      <div class="px-6 py-5 text-center">
        <div class="flex flex-col items-center">
          ...
          <span class="text-xl font-medium">{cardsOwnedCount}</span>
