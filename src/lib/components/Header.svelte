...
<header class="bg-surface-50 border-b border-surface-200/50 sticky top-0 z-50 transition-all duration-200">
        <div class="container mx-auto flex justify-between items-center h-16 px-4">
                ...
                <nav class="hidden lg:flex items-center space-x-1">
                        <a href="/" 
                           class="flex items-center space-x-1 px-3 py-2 rounded-full transition-all hover:bg-primary-500/10">
                           <Sprout size={18} />
                           <span>Home</span>
                        </a>
        ...
        {#if isMenuOpen}
            ...
            <div class="lg:hidden fixed inset-y-0 right-0 z-50 w-64 bg-surface-100 shadow-xl transform transition-transform duration-300 ease-in-out {isMenuOpen ? 'translate-x-0' : 'translate-x-full'}">
                <div class="p-5 flex flex-col h-full">
                    ...
                    <div class="mt-auto pt-5 border-t border-surface-300/20">
                        {#if $userStore.isAuthenticated}
                            <button 
